          ...
          <ResponsiveContainer>
            <ComposedChart data={rows} margin={{ top: 8, right: 20, bottom: 0, left: 0 }}>
              ...
              <ReferenceLine y={s.median} stroke={GOLD} strokeDasharray="5 4"
                label={{ value: `Mediana ${fmtBRLShort(s.median)}`, position: "insideTopRight", fill: GOLD, fontSize: 11 }} />
            </ComposedChart>
          </ResponsiveContainer>
        </div>
        <Reading>
        ...
        <div style={{ width: "100%", height: 340 }}>
          <ResponsiveContainer>
            <BarChart data={rows} margin={{ top: 8, right: 20, bottom: 0, left: 0 }}>
              ...
              <ReferenceLine y={brasil} stroke={RED} label={{ value: `Brasil ${fmtBRL(brasil)}`, position: "insideTopRight", fill: RED, fontSize: 11 }} />
              <ReferenceLine y={s.median} stroke={GOLD} strokeDasharray="5 4" />
            </BarChart>
          </ResponsiveContainer>
        </div>
