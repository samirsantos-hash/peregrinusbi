...
const ExecutivePanel = ({ kpis }: ExecutivePanelProps) => {
  ...
  const metrics = [
    ...
    },
    {
      ...
      color: avgUplift >= 0 ? "emerald-text" : "critical-text",
    ...
    },
    {
      ...
      icon: Activity,
      color: avgSaude >= 70 ? "emerald-text" : avgSaude >= 50 ? "warning-text" : "critical-text",
    ...
    },
    {
      ...
      icon: Clock,
      color: avgDelayed <= 0.05 ? "emerald-text" : "critical-text",
