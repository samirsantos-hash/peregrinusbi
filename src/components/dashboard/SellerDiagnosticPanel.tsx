...
import { Award, Layers, Tag, MapPin, Clock, ShieldCheck, Truck, Package, Zap, CheckCircle2, AlertTriangle, XCircle } from "lucide-react";
...
const SellerDiagnosticPanel = ({ seller, allKpis }: Props) => {
  ...
  // ---- Envios / Full / Flex ----
  const shareFull = Number(latest.shareFullPct) || 0;
  const shareFlex = Number(latest.shareFlexPct) || 0;
